...
public class ExcelHandler {
    ...
    public static List<Map<String, String>> readExcel(String excelFilepath, String sheetName) throws IOException {
            ...
            for (int c = 0; c < xssfRow.getLastCellNum(); c++) {
                if (i == 0) {
                    ...
                    if (xssfRow.getCell(c).getCellType() == CellType.NUMERIC) {
                        rowDictionary.put(heading.get(c), String.valueOf((int) xssfRow.getCell(c).getNumericCellValue()));
                    } else {
